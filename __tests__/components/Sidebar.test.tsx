...
describe('Sidebar', () => {
  ...
  describe('Empty state', () => {
    it('renders with no repos', () => {
      const { getByText } = render(
        <Sidebar repos={[]} collapsed={{}} {...mockCallbacks} />,
      );
  ...
  describe('Repository list', () => {
    ...
    it('renders repository name', () => {
      const { getByText } = render(
        <Sidebar repos={[mockRepo]} collapsed={{}} {...mockCallbacks} />,
      );
  ...
  describe('Branch selection', () => {
    ...
    it('calls onSelectBranch when branch is pressed', () => {
      ...
      expect(mockCallbacks.onSelectBranch).toHaveBeenCalledWith(
        'repo-1',
        'develop',
      );
    });
  ...
  describe('Multiple repositories', () => {
    ...
    it('renders all repositories', () => {
      const { getByText } = render(
        <Sidebar repos={mockRepos} collapsed={{}} {...mockCallbacks} />,
      );
